    ...
    def show_mark_attendance(self):
        def view():
            ...
            def load_students():
                ...
                if not students:
                    ttk.Label(list_frame, text="No students found.").pack()
                    return
                ...
                ttk.Label(list_frame, text=f"Session #{session_id} Created. Mark below:", style="CardHeader.TLabel").pack(pady=10)
                ...
                for s in students:
                    ...
                    ttk.Label(row, text=f"{s['first_name']} {s['last_name']} (ID: {s['student_id']})", width=30, anchor='w').pack(side='left')
